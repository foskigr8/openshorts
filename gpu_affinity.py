...
Environment
-----------
CLIP_GPUS   comma-separated device indices to spread across (default: every
            visible CUDA device). "0" pins everything to GPU 0 — the old
            behaviour. Ignored when CUDA is unavailable.
"""
